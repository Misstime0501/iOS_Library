...
// HAObjectSchema private
@interface HAObjectSchema ()
...
@property (nonatomic, readwrite) HAProperty *primaryKeyProperty;

// The Realm retains its object schemas, so they need to not retain the Realm
@property (nonatomic, unsafe_unretained) HARealm *realm;
// returns a cached or new schema for a given object class
+(instancetype)schemaForObjectClass:(Class)objectClass;

// generate a schema from a table
+(instancetype)schemaFromTableForClassName:(NSString *)className realm:(HARealm *)realm;
